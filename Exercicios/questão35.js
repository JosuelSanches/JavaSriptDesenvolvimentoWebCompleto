...
Inicialmente, o vetorPilha conterá cinco elementos
inteiros: [1, 2, 3, 4, 5]. 
...
e mostrá-los no console.
 ...
 vetorPilha = vetorPilha.concat(vetorAdciona)
 console.log(`O vetor pilha é ${vetorPilha} e o vetor adiciona é ${vetorAdciona}`)